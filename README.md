# Biodata
Name: Brandon Yang<br/>
LinkedIn: https://www.linkedin.com/in/brandon-yang-404ba1315/<br/>
Portfolio: https://brandon-yang.netlify.app
...
Here's the representation of Object Relational Mapping for H2 Databases that persisted in https://github.com/DonnnChaewon/Listing-Service-Management-API/blob/main/data/testdb.mv.db
![Object Relational Mapping](https://github.com/DonnnChaewon/Listing-Service-Management-API/blob/main/image-documentation/ObjectRelationalMapping.png)
...
```
###### Proof
![Create listing](https://github.com/DonnnChaewon/Listing-Service-Management-API/blob/main/image-documentation/CreateListing.png)
...
```
###### Proof
![Get all users](https://github.com/DonnnChaewon/Listing-Service-Management-API/blob/main/image-documentation/GetAllUsers.png)
...
```
###### Proof
![Get specific user](https://github.com/DonnnChaewon/Listing-Service-Management-API/blob/main/image-documentation/GetSpecificUser.png)
...
```
###### Proof
![Create user](https://github.com/DonnnChaewon/Listing-Service-Management-API/blob/main/image-documentation/CreateUser.png)
...
```
###### Proof
![Get listings Public API](https://github.com/DonnnChaewon/Listing-Service-Management-API/blob/main/image-documentation/GetAllListingsPublicAPI.png)
...
```
###### Proof
![Create user Public API](https://github.com/DonnnChaewon/Listing-Service-Management-API/blob/main/image-documentation/CreateUserPublicAPI.png)
...
```
###### Proof
![Create listing Public API](https://github.com/DonnnChaewon/Listing-Service-Management-API/blob/main/image-documentation/CreateListingPublicAPI.png)
